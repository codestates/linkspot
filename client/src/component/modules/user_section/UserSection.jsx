    ...
    <>
      ...
      <section className='my-info'>
        ...
        <div className='icon-container'>
          {/* 마이크 및 헤드셋 컨트롤 버튼 */}
          {micOff ? (
            <BsFillMicMuteFill onClick={() => setMicOff(!micOff)} />
          ) : (
            <BsFillMicFill onClick={() => setMicOff(!micOff)} />
          )}
          {soundOff ? (
            <MdHeadsetOff onClick={() => setSoundOff(!soundOff)} />
          ) : (
            <MdHeadsetMic onClick={() => setSoundOff(!soundOff)} />
          )}
          {/* 개인정보 수정 버튼 */}
